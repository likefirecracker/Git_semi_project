...
<html lang="ko">
  ...
  <body class="vertical  dark  ">
        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              ...
              <form action="orderEdit.jsp?pageNum=<%= pageNum %>" method="post">
					...
					<td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="?pages=orderEdit&oDNum=<%= o_dNum%>">수정</a>
                        </div>
                      </div>
	...
	%>
		...
		%>
                  	  <a class="page-link" href="orderList.jsp&pageNum=<%= startPage-pageBlock %>">이전</a>
        <%
			}
		%>
                  </li>
		...
		%>
				<a class="page-link" href="orderList.jsp&pageNum=<%= i %>"><%= i %></a>
		<%	
				}
			}
		%>
		...
		%>
				<a class="page-link" href="orderList.jsp&pageNum=<%= startPage+pageBlock %>">다음</a>
		<%
			}
		%>          
                  </li>
